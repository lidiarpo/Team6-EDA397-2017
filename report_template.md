...
**Overview of Aviato App**
![Alt text](https://cloud.githubusercontent.com/assets/5904540/26174256/07d135ba-3b4f-11e7-95e7-a66deae5c238.png)

<ol type="A">
<li>Home Screen</li>
In this screen we have displayed 4 buttons, namely Find Flights, Subscriptions, Notifications and Settings. 
<li>Find flights</li> 
When the Find Flights button is selected, this screen will be displayed. Where we can see the list of flights for arrivals and departures
<li>Filters applied by the user on the list of flights</li>
This screen is the result of selecting Filter Flights button. It has 3 options, they are: Select Filters, Airline and Time Window. 
<li>Detailed information on a specific flight</li>
Whenever user selects any flight item from the flight list, then that action will display this screen with the information for that specific flight.
<li>Subscriptions screen</li>
In this screen, we have presented the list of flight subscription
<li>Notification</li>
In this screen, we have exhibited the pop up notifications for reminder for the user which is generated by our app. 
<li>Notifications History</li>
In this screen, we have displayed the history of pop-up notifications.
<li>Settings Screen</li>
In this screen we have displayed the settings for notification control, subscription control and also a bit information about our app.
</ol>
